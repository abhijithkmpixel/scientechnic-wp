<?php
/* Template Name: About Qhse Policy page */
/* */
?>
                  ...
                  $i= 0;
                        if (have_rows('partners_details')):
                              while (have_rows('partners_details')):the_row();
                                    $title = get_sub_field('title_normal');
                                    $description = get_sub_field('description_normal');
                                    $image_normal_img = get_sub_field('image_normal');
                                    $description_long = get_sub_field('description_long');
                                    $image_normal = $image_normal_img['url'];
                                    $clss = ($i % 2 == 0) ? 'sc-container-warp' : 'greyone';
            ?>
                                          ...
                                          <div class="sc-container-warp">
                                                <div class="outer-act">
                                                      <div class="col-md-12">
                                                            ...
                                                            <?php if($description_long):echo'<div class="expand">
                                                                        '.$description_long.'
                                                                  </div>
                                                                  <span class="xpand-btn">Read more</span>'; endif;?>
                                                      </div>
                                                      <?php if($image_normal): echo'<div class="col-md-6 img-bg">
                                                            <img src="'.$image_normal.'" class="img-responsive"alt="'.$image_normal_img['alt'].'"/>
                                                      </div>'; endif;?>
                                                      </div>
                                                </div>
                                          </div>
