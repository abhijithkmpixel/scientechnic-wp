                                          ...
                                          <div class="slider-content">
                                                ...
                                                <div class="container down-scroller">
                                                      ...
                                                      <div class="bc">
                                                            ...
                                                            <span class="ccm-autonav-breadcrumb-sep">/</span> QHSE policy
                                                      </div>
                                                </div>
                                          </div>
                        <?php
          ...
          <div class="make-enquery-wrap">
            ...
            <div id="formidable_container_3" class="formidable">
              ...
              >
                ...
                <input type="hidden" name="cID" id="cID3" value="216" />
          ...
          <div class="modal-body make-enquery-wrap">
            ...
            <div id="formidable_container_5" class="formidable">
              ...
              >
                ...
                <input type="hidden" name="cID" id="cID5" value="216" />
      ...
      <div class="container">
            ...
            if (have_rows('description')):
                  while (have_rows('description')):
                        the_row();
                        $title = get_sub_field('title');
                        $description_d = get_sub_field('description_d');
                        ?>
...
<div class="business-partners-wrap">
      <div class="container">
            <?php
                  $partners = get_field('partners');
                  if ($partners):
            ?>
                        <ul class="partners-list list-inline exclusive-partners-list partners-only">
                              <?php foreach ($partners as $partners_data):
                                    $logo = get_field('logo',$partners_data->ID);
                                    $title = get_the_title( $partners_data->ID );
                                    $permalink = get_permalink( $partners_data->ID );
                              ?>
                                    <li class="no-rightborder wow fadeInUp">
                                          <a href="<?php echo $permalink;?>">
                                                <?php if($logo): echo'<img class="img-responsive" src="'.$logo.'"alt="'.$title.'"target="_self"/>'; endif;?>
                                          </a>
                                          <div class="clearfix"></div>
                                          <?php  echo'<a class="more-link" href="'.$permalink.'">Click to Explore</a>';?>
                                    </li>
                              <?php endforeach; ?>
                        </ul>
            <?php endif; ?>
            ...
            <?php 
                  $see_all_ = get_field('see_all_');
                  if( $see_all_ ): 
                        $see_all__url = $see_all_['url'];
                        $see_all__title = $see_all_['title'];
                        $see_all__target = $see_all_['target'] ? $see_all_['target'] : '_self';
            ?>
                        <a class="partner-btn" href="<?php echo esc_url( $see_all__url ); ?>" target="<?php echo esc_attr( $see_all__target ); ?>"><?php echo esc_html( $see_all__title ); ?></a>
            <?php endif; ?>
            </div>
      </div>
</div>
