<?php
/* Template Name: About Overview page */
/* */
?>
...
<div class="banner-area">
      ...
      ?>
                        ...
                        <div id="slides">
                              <?php if($image): echo'<ul class="slides-container">
                                    <li>
                        ...
                        <div class="slider-content">
                              <div class="container move-uper">
                                    <div class="content-holdingg wow fadeInUp">
                                          ...
                                          <?php if($description): echo'<p>'.$description.'</p>'; endif;?>
                                    </div>
                              </div>
                              <div class="container down-scroller">
                                    ...
                                    <div class="bc">
                                          ...
                                          <span class="ccm-autonav-breadcrumb-sep">/</span> About
                                    </div>
                              </div>
                        </div>
      <?php
          ...
          <div class="make-enquery-wrap">
            ...
            <div id="formidable_container_3" class="formidable">
              ...
              >
                ...
                <input type="hidden" name="cID" id="cID3" value="124" />
                ...
                <input
                  ...
                  name="ccm_token"
                  id="ccm_token3"
                  value="1696501028:165469f98f0fc9d1813c9ab97132ab39"
                />
          ...
          <div class="modal-body make-enquery-wrap">
            ...
            <div id="formidable_container_5" class="formidable">
              ...
              >
                ...
                <input type="hidden" name="cID" id="cID5" value="124" />
...
<div class="sub-navhead">
        <div class="container">
          <ul class="nav desktopver list-inline">
            ...
            <li class="">
              <a href="easa-saleh/index.html" target="_self" class=""
                >Easa Saleh Al Gurg Group</a
              >
            </li>
            <li class="">
              <a href="empowering-tomorrow/index.html" target="_self" class=""
                >QHSE policy</a
              >
            </li>
            <li class="">
      ...
      <div class="container">
            <div class="col-sm-12">
                  <div class="center dynamite">
                        <?php
                              if(have_rows('about_scientechnic')):
                                    while(have_rows('about_scientechnic')):the_row();
                                          $title = get_sub_field('title');
                                          $description = get_sub_field('description');
                        ?>


                                          <?php if($title): echo'<h2 style="text-align: center">'.$title.'</h2>'; endif;?>
                  ...
                  <div class="columns-row row">
                        ...
                        ?>
                                          ...
                                          <div class="col-md-6">
                                                <?php if($short_description):echo''.$short_description.''; endif;?>
                                          </div>
                        <?php
                                    endwhile;
                              endif;
...
<div class="about-overview">
      <div class="container">
            <div class="col-sm-12 links-hoster">
                  <div class="col-sm-12">
                        <div class="project-gallery row">
                              <?php
                                    if(have_rows('image')):
                                          while(have_rows('image')):the_row();
                                                $image_rep_img = get_sub_field('image_rep');
                                                $image_rep = $image_rep_img['url'];
                              ?>
                                                <?php if($image_rep): echo'<div class="col-sm-4 slide">
                                                      <a class="fancybox-img" rel="gallery" href="'.$image_rep.'">
                                                            <img class="img-responsive" src="'.$image_rep.'"alt="'.$image_rep_img['alt'].'"/>
                                                      </a>
                                                </div>'; endif;?>
                              <?php
                                          endwhile;
                        ...
                        <?php
                              if(have_rows('text')):
                                    while(have_rows('text')):the_row();
                                          $title = get_sub_field('title');
                        ?>
                                          <?php if($title): echo'<li>'.$title.'</li>'; endif;?>
                        <?php
                                    endwhile;
                              endif;
                        ?>
...
<div class="center timeline-heading">
      <?php $title_journey = get_field('title_journey');
            if($title_journey): echo'<h2>'.$title_journey.'</h2>'; endif;
      ?>
</div>

<div class="timelinegal lighter-grey" id="historyDiv">
      <div class="events-content odd fadeInUp">
            <ul class="galtl-list list-inline">
                  <?php
                        $i = 0;
                              if(have_rows('our_journey')):
                                    while(have_rows('our_journey')):the_row();
                                          ...
                                          $description = get_sub_field('description');
                                          $class = ($i % 2 == 0) ? 'gal-moment' : 'gal-moment odd';    
                  ?>
                                          <li class="<?php echo $class;?>">
                                                <div class="row moment-description">
                                                      <?php if($image): echo'<div class="col-sm-4 timeline-img">
                                                            <img src="'.$image.'"class="img-responsive"alt="'.$year.'"/>
                                                      </div>'; endif;?>
                                                      <div class="col-md-8 moment-details">
                                                            <div class="timeline-content">
                                                                  <?php if($year): echo'<h4>'.$year.'</h4>'; endif;?>
                                                                  <?php if($description): echo''.$description.''; endif;?>
                                                            </div>
                                                      </div>
                                                </div>
...
<div class="container">
      <div class="static-informatics">
        <?php
          if(have_rows('scientechnic')):
            while(have_rows('scientechnic')):the_row();
              $description = get_sub_field('description');
              $profile_image_img = get_sub_field('profile_image');
              $profile_image = $profile_image_img['url'];
        ?>
                <?php if($profile_image): echo'<div class="col-md-5">
                      <img src="'.$profile_image.'" class="img-responsive"/>
                </div>'; endif;?>
                <div class="col-md-7 green-back">
                      <?php if($description): echo''.$description.''; endif;?>
                </div>
        <?php
            endwhile; 
