            ...
            ?>
                              ...
                              <div id="slides">
                                    <ul class="slides-container">
                                          <li>
                                                <?php if($image): echo'<img class="center center" src="'.$image.'" alt="'.$image_img['alt'].'"/>'; endif;?>
                                          </li>
                                    </ul>
                              </div>
          ...
          <div class="make-enquery-wrap">
            ...
            <div id="formidable_container_3" class="formidable">
              ...
              >
                ...
                <input type="hidden" name="cID" id="cID3" value="125" />
          ...
          <div class="modal-body make-enquery-wrap">
            ...
            <div id="formidable_container_5" class="formidable">
              ...
              >
                ...
                <input type="hidden" name="cID" id="cID5" value="125" />
                        ...
                        <div class="col-sm-12">
                              <div class="center dynamite">
                                    ...
                                    ?>
                                          ...
                                          <?php if($description): echo'<p style="text-align: justify">'.$description.'</p>'; endif;?>
                              </div>
                              ...
                              $result = new WP_Query( $args );
                                    if ( $result-> have_posts() ) :
                                          while ( $result->have_posts() ) : $result->the_post();
                                                ...
                                                $link_show_hide = get_field('link_show_hide', $result->ID);
                                                $link = get_permalink($result->ID);

                  ?>
                                                <li class="no-rightborder wow fadeInUp">
                                                      <?php if($link_show_hide == $link){?>
                                                            <a href="<?php echo $link; ?>">
                                                                  <?php if($logo): echo'<img class="img-responsive" src="'.$logo.'"target="_self"/>'; endif;?>
                                                            </a>
                                                      <?php }else{
                                                      ?>
                                                            <div>
                                                      ...
                                                      <?php if($link_show_hide == $link):?><a class="more-link" href="<?php echo $link; ?>">Click to Explore</a><?php endif;?>
                                                </li>
                  <?php
                                          endwhile;
                                    endif;
